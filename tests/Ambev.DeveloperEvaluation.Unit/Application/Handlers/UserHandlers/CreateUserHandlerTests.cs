...
using Ambev.DeveloperEvaluation.Unit.Application.Handlers.UserHandlers.TestData;
using AutoMapper;
using FluentAssertions;
using NSubstitute;
using Xunit;

namespace Ambev.DeveloperEvaluation.Unit.Application.Handlers.UserHandlers;
